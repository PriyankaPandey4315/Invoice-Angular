export const MenuItems=[
    {icon:'ri-home-6-line', label: 'Hospital Dashboard', path: '/hospital-dashboard', children: []},
    {icon:'ri-home-smile-2-line', label: 'Medical Dashboard', path: '/medical-dashboard', children: []},
    {icon:'ri-home-5-line', label: 'Dentist Dashboard', path: '/dentist-dashboard', children: []},
    {icon: 'ri-stethoscope-line', label: 'Doctors', path: '/doctors-dashboard', children: [
    ...
    {icon:'ri-heart-pulse-line', label: 'Patients', path: '/patients', children: [
    ...
    {icon:'ri-nurse-line', label: 'Staff', path: '/staff', children: [ 
    ...
    {icon:'ri-dossier-line', label: 'Appointments', path: '/appointments', children: [
      ...
      {icon: '', label: 'Edit Appointment', path: '/package.jsonappointments/edit-appointment'},
     ]},
     {icon: 'ri-building-2-line', label: 'Departments', path: '/departments', children: [
     ...
     {icon: 'ri-secure-payment-line', label:'Accounts', path: '/accounts', children: [
     ...
     {icon:'ri-group-2-line', label:'Human Resources', path: '/human-resources', children: [
     ...
     {icon:'ri-money-dollar-circle-line', label:'Salaries', path: '/salaries', children: [
      {icon:'', label:'Salary List', path: '/salaries/salary-list'},
      {icon:'', label:'Payslip', path: '/salaries/payslip'},
     ]},
     {icon:'ri-hotel-bed-line', label:'Rooms', path:'/rooms', children:[
    ...
    {icon:'ri-car-washing-line', label:'Ambulance', path:'/ambulance', children:[
    ...
    {icon:'ri-calendar-line', label:'Event Management', path:'/event-management', children:[]},
    {icon:'ri-tent-line', label:'Gallery', path:'/gallery', children:[]},
    {icon:'ri-news-line', label:'News & updates', path:'/news-updates', children:[]},
    {icon:'ri-color-filter-line', label:'UI Elements', path:'/ui-elements', children:[
     ...
     {icon:'ri-notification-badge-line', label:'Jquery Components', path:'/jquery-components', children:[
    ...
    {icon:'ri-terminal-window-line', label:'Forms', path:'/forms', children:[
    ...
    {icon:'ri-table-line', label:'Tables', path:'/tables', children:[]},
    {icon:'ri-bar-chart-line', label:'Graphs', path:'/graphs', children:[
     ...
     {icon:'ri-road-map-line', label:'Vector Maps', path:'/vactor-maps', children:[]},
     {icon:'ri-send-plane-2-line', label:'Icons', path:'/icons', children:[]},
     {icon:'ri-settings-5-line', label:'Account Settings', path:'/account-settings', children:[]},
     {icon:'ri-font-size', label:'Topography', path:'/topography', children:[]},
     {icon:'ri-login-circle-line', label:'Login/Signup', path:'/login-signup', children:[
    ...
    {icon:'ri-alert-line', label:'Page Not Found', path:'/page-not-found', children:[]},
    {icon:'ri-auction-line', label:'Maintenance', path:'/maintentance', children:[]},
    {icon:'ri-dropdown-list', label:'Menu Level', path:'/menu-level', children:[
    ...
    {icon:'ri-send-plane-line', label:'External Link', path:'/external-link', children:[]},
    {icon:'ri-exchange-line', label:'Chip', path:'/chip', children:[]},
    {icon:'ri-ticket-line', label:'Badge', path:'/badge', children:[]},
    {icon:'ri-magic-line', label:'Disabled Link', path:'/diabled-link', children:[]},
  ]
